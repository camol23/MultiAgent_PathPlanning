...
class path_follower:
    ...
    def step(self, state, vis=False, momentary_flag=False):
        ...
        if momentary_flag :
            print(" PID Tr ", self.Tr[self.idx+1], self.Tr[self.idx])
            print("Orientation of the line segment",  math.atan2(self.v[1], self.v[0]))
            print()
