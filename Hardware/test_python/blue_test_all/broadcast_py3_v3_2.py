...
class BLEAdvertisement:
    ...
    def create_advertisement(self, message):
        ...
        if self.advertisement:
            try:
                ...
                print("Error unregistering previous advertisement: ",e) #print(f"Error unregistering previous advertisement: {e}")
        ...
        try:
            ...
            print("Failed to create advertisement: ", e) #print(f"Failed to create advertisement: {e}")
            return False
    ...
    def register_ad_error_cb(self, error):
        print("Failed to register advertisement:", error) #print(f"Failed to register advertisement: {error}")
        self.mainloop.quit()
    ...
    def stop_advertising(self):
        if self.advertisement:
            try:
                ...
                print("Error unregistering advertisement: ", e) #print(f"Error unregistering advertisement: {e}")
                    ...
                    if line:
                        ...
                        if not self.hcidump_available and not shutil.which('btmon'):
                            if "PC-Master" in line:
                                # print(f"Detected PC-Master: {line}")
                                print("Detected PC-Master: "+str(line))
                                # We can only get the device name, not the data
    ...
    def _monitor_with_btmon(self):
        try:
            ...
            while self.running:
                ...
                if "PC-Master" in line:
                    # print(f"Detected PC advertisement: {line}")
                    print("Detected PC advertisement: ",line)
            ...
            # print(f"Error with btmon: {e}")
            print("Error with btmon: ",e)
        finally:
            if self.dump_process:
                try:
                    self.dump_process.terminate()
        ...
        try:
            ...
            if "ff ff" in data.lower():
                ...
                try:
                    ...
                    # print(f"Received from PC (Target: {target_id}): {message}")
                    print("Received from PC (Target: ",target_id,": ",message)
                except Exception as e:
                    # print(f"Error decoding message: {e}")
                    print("Error decoding message: ", e)
                    
        except Exception as e:
            # print(f"Error processing btmon data: {e}")
            print("Error processing btmon data: ",e)
