...
import threading
import time
import socket  # Import standard socket module for constants
...
class EV3Server:
    ...
    def start(self):
        try:
            ...
            # Use standard socket module constants instead
            try:
                self.server_socket.setsockopt(socket.SOL_SOCKET, socket.SO_REUSEADDR, 1)
            except Exception as e:
                print("Note: Couldn't set socket options, continuing anyway:", e)
        ...
        while self.running:
            try:
                ...
                try:
                    ...
                    # If timeout setting fails, just continue
                    pass
    ...
    def handle_connection(self, sock):
        try:
            ...
            try:
                ...
                pass  # Continue even if setting timeout fails
            ...
            try:
                ...
                try:
                    sock.shutdown(2)  # Try to shut down but continue if it fails
                except:
                    pass
                sock.close()
            except:
