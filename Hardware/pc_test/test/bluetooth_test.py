...
from ctypes import addressof, sizeof, ARRAY
#, UINT8, UINT16
...
UINT8 = 0b0000_0000 
UINT16 = 0b0000_0000_0000_0000

sa_family_t = UINT16

# bd_addr_t = {"b": (ARRAY | 0, UINT8 | 6)}
bd_addr_t = {"b": (UINT16 | 0, UINT8 | 6)}
...
class RFCOMMServer:
    ...
    def __init__(self, server_address, RequestHandlerClass):
        ...
        try:
            # addr_data = bytearray(sizeof(sockaddr_rc)) # Original
            addr_data = bytearray(64)
